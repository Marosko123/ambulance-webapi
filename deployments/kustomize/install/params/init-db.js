...
let result = db[collection].insertMany([
    {
        ...
        "predefinedConditions": [
            { "value": "Nadcha", "code": "rhinitis", "typicalDurationMinutes": 20 },
            { "value": "Kontrola", "code": "checkup", "typicalDurationMinutes": 15 },
            { "value": "Teploty", "code": "subfebrilia", "reference": "https://zdravoteka.sk/priznaky/zvysena-telesna-teplota/", "typicalDurationMinutes": 20 },
            { "value": "Nevolnost", "code": "nausea", "reference": "https://zdravoteka.sk/priznaky/nevolnost/", "typicalDurationMinutes": 45 },
            { "value": "Odber krvi", "code": "blood-test", "typicalDurationMinutes": 10 }
        ]
    }
]);
